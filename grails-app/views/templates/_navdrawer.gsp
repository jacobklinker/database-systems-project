    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <sec:ifAnyGranted roles="ROLE_ADMIN">
                <a class="mdl-navigation__link" href="${createLink(controller: 'scanAll', action: 'allUser')}">View All Users</a>
                <a class="mdl-navigation__link" href="${createLink(controller: 'user')}">Change User Role</a>
