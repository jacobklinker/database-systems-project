                    ...
                    <table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
                        ...
                        <tbody>
                            <g:each in="${rooms}" var="room">
                                <tr>
                                    <td class="mdl-data-table__cell--non-numeric clickable-cell" data-href="${createLink(action: 'saveRecureserveByMonth')}?date=${date}&room=${room.id}">${room.description}</td>
                                </tr>
                            </g:each> 
                        </tbody>
                    </table>
